...
#    files_pairs = np.array(files_pairs)
    ...
    train_files = np.array_split(files_pairs, n_folds)#seperate npz files into 20 subject pairs
    folds_data = {}
    for fold_id in range(n_folds):
        subject_files = train_files[fold_id]
        ...
        folds_data[fold_id] = [training_files, subject_files]#one pair as val data, left pairs as training data
    return folds_data
